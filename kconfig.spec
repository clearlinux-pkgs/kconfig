...
Version  : 6.12.0
Release  : 104
URL      : https://download.kde.org/stable/frameworks/6.12/kconfig-6.12.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.12/kconfig-6.12.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.12/kconfig-6.12.0.tar.xz.sig
...
%setup -q -n kconfig-6.12.0
cd %{_builddir}/kconfig-6.12.0
pushd ..
cp -a kconfig-6.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742404745
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6ConfigCore.so.6.12.0
/V3/usr/lib64/libKF6ConfigGui.so.6.12.0
/V3/usr/lib64/libKF6ConfigQml.so.6.12.0
/V3/usr/lib64/qt6/qml/org/kde/config/libKF6ConfigQmlplugin.so
/usr/lib64/libKF6ConfigCore.so.6
/usr/lib64/libKF6ConfigCore.so.6.12.0
/usr/lib64/libKF6ConfigGui.so.6
/usr/lib64/libKF6ConfigGui.so.6.12.0
/usr/lib64/libKF6ConfigQml.so.6
/usr/lib64/libKF6ConfigQml.so.6.12.0
