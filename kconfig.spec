...
Source0  : https://download.kde.org/stable/frameworks/5.100/kconfig-5.100.1.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.100/kconfig-5.100.1.tar.xz.sig
...
%prep
%setup -q -n kconfig-5.100.1
cd %{_builddir}/kconfig-5.100.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668723495
mkdir -p clr-build
pushd clr-build
