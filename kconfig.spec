...
%prep
%setup -q -n kconfig-5.98.0
cd %{_builddir}/kconfig-5.98.0
...
/usr/lib64/libKF5ConfigCore.so.5.98.0
/usr/lib64/libKF5ConfigGui.so.5
/usr/lib64/libKF5ConfigGui.so.5.98.0
/usr/lib64/libKF5ConfigQml.so.5
/usr/lib64/libKF5ConfigQml.so.5.98.0
