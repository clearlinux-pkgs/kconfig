...
Source0  : https://download.kde.org/stable/frameworks/5.107/kconfig-5.107.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.107/kconfig-5.107.0.tar.xz.sig
...
%prep
%setup -q -n kconfig-5.107.0
cd %{_builddir}/kconfig-5.107.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686496693
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5ConfigCore.so.5.107.0
/V3/usr/lib64/libKF5ConfigGui.so.5.107.0
/V3/usr/lib64/libKF5ConfigQml.so.5.107.0
/usr/lib64/libKF5ConfigCore.so.5
/usr/lib64/libKF5ConfigCore.so.5.107.0
/usr/lib64/libKF5ConfigGui.so.5
/usr/lib64/libKF5ConfigGui.so.5.107.0
/usr/lib64/libKF5ConfigQml.so.5
/usr/lib64/libKF5ConfigQml.so.5.107.0
