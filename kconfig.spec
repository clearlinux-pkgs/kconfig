...
Version  : 5.104.0
Release  : 69
URL      : https://download.kde.org/stable/frameworks/5.104/kconfig-5.104.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.104/kconfig-5.104.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.104/kconfig-5.104.0.tar.xz.sig
...
%prep
%setup -q -n kconfig-5.104.0
cd %{_builddir}/kconfig-5.104.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679516364
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5ConfigCore.so.5.104.0
/usr/lib64/libKF5ConfigGui.so.5
/usr/lib64/libKF5ConfigGui.so.5.104.0
/usr/lib64/libKF5ConfigQml.so.5
/usr/lib64/libKF5ConfigQml.so.5.104.0
